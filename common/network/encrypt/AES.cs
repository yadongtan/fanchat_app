...
public class AES
{
    private static byte[] key = System.Text.Encoding.ASCII.GetBytes("bGcGfWb3Kg2s4gcG");
    private static byte[] iv = System.Text.Encoding.ASCII.GetBytes("aebksHkG4jAEk2Ag");
    ...
    {
        return Convert.ToBase64String(Encrypt(key, iv, data));
    }
